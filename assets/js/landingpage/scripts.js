...
jQuery(function ($) {
    ...
    function count(counters, start, value, id) {
        ...
        interval = setInterval(function () {
            if (localStart + inc > value && localStart < value) {
    ...
    $('.benifit-carousel-a').owlCarousel({
        autoplay: false,
        loop: true,
        margin: 15,
        dots: true,
